...
<template>
    <DialogRoot v-model:open="dialogOpen">
        <DialogPortal>
            ...
            >
                <DialogTitle class="text-lg font-semibold text-slate-900">Create New Item</DialogTitle>
                <DialogDescription class="mt-2 text-sm text-slate-600">Enter the name of the new item.</DialogDescription>
                <form @submit.prevent="submit">
                    <label class="text-sm font-medium text-slate-700" for="name">Item Name</label>
                    <div>
                        <input
                            id="name"
                            v-model="form.name"
